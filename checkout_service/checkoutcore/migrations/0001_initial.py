    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkout', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='checkout_items', to='checkoutcore.checkout')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='checkout',
            name='status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='status', to='checkoutcore.status'),
        ),
    ]
